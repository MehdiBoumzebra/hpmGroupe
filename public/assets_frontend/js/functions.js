...
! function ($) {
    ...
    SEMICOLON.initialize = {
                    ...
                    if (swiperSlider = new Swiper(element.find(".swiper-parent"), {
                            ...
                            on: {
                                init: function (e) {
                                    ...
                                    }), element.find("[data-animate]:not(img)").each(function () {
                                        var e = $(this),
                                ...
                                transitionStart: function (e) {
                                    slideNumberCurrent.length > 0 && (1 == elementLoop ? slideNumberCurrent.html((Number(element.find(".swiper-slide.swiper-slide-active").attr("data-swiper-slide-index")) + 1).pad()) : slideNumberCurrent.html((swiperSlider.activeIndex + 1).pad())), element.find("[data-animate]:not(img)").each(function () {
                                        var e = $(this),
                                            t = e.attr("data-animate");
                                        if (e.parents(".swiper-slide").hasClass("swiper-slide-active")) return !0;
                                        e.removeClass("animated").removeClass(t).addClass("not-animated")
                        ...
                        }), slideNumberCurrent.length > 0 && (1 == elementLoop ? slideNumberCurrent.html((swiperSlider.realIndex + 1).pad()) : slideNumberCurrent.html((swiperSlider.activeIndex + 1).pad())), slideNumberTotal.length > 0 && slideNumberTotal.html((element.find(".swiper-slide:not(.swiper-slide-duplicate)").length).pad()), sliderSettings)
            ...
            if ($sliderParallaxEl.length > 0)
                if (!$body.hasClass("device-xl") && !$body.hasClass("device-lg") || SEMICOLON.isMobile.any()) $sliderParallaxEl.find(".slider-arrow-left,.slider-arrow-right,.vertical-middle:not(.no-fade),.slider-caption,.ei-title,.camera_prev,.camera_next").css({
                    ...
                    if ($slider.length > 0) {
                        ...
                        $sliderParallaxEl.find(".emotion-slider,.slider-arrow-left,.slider-arrow-right,.vertical-middle:not(.no-fade),.slider-caption,.ei-title,.camera_prev,.camera_next").css({
        ...
        instagramPhotos: function (e, t) {
            ...
            a.length > 0 && a.each(function () {
                ...
                if (n || (n = 9), l || (l = "none"), d || (d = "thumbnail"), "user" == r) var c = new Instafeed({
                    ...
                    accessToken: e,
                    clientId: t,
                    template: '<div class="oc-item instagram-item"><div class="img-backdrop"></div><a href="{{link}}"><img src="{{image}}" alt="Clients"><div class="description-container"><span class="insta-likes"><i class="icon-heart3"></i>{{likes}}</span><span class="insta-comments"><i class="icon-comment"></i>{{comments}}</span></div></a></div>'
                });
        ...
        init: function () {
            SEMICOLON.slider.captionPosition(), SEMICOLON.slider.swiperSliderMenu(!0), SEMICOLON.slider.revolutionSliderMenu(!0), SEMICOLON.initialize.testimonialsGrid(), SEMICOLON.initialize.verticalMiddle(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.initialize.stickyFooter(), SEMICOLON.portfolio.gridInit($gridContainer), SEMICOLON.portfolio.filterInit(), SEMICOLON.portfolio.shuffleInit(), SEMICOLON.portfolio.arrange(), SEMICOLON.portfolio.portfolioDescMargin(), SEMICOLON.widget.parallax(), SEMICOLON.widget.loadFlexSlider(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.widget.ticker(), SEMICOLON.header.topsocial(), SEMICOLON.header.responsiveMenuClass(), SEMICOLON.initialize.modal(), SEMICOLON.widget.carousel()
        }
    };
    var $window = $(window),
        $body = $("body"),
