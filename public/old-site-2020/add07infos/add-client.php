		...
		<div class="div_main">
			<br/>
			<div class="txt_1"><b>Creer nouveaux client:</b></div>
			...
			<div class="div_form">
				...
				<tr>
					<td class="txt_black" align="left"><b>Société : </b></td>
					<td class="txt_black" align="left"><input name="societe" type="text" size="21" maxlength="99" value=""></td>
					<td class="txt_black" align="left" valign="top"><b>GSM : </b></td>
					<td class="txt_black" align="left"><input name="gsm" type="text" size="21" maxlength="99" value=""><br /></td>
				</tr>
				<tr>
					...
					<td class="txt_black" align="left"><input name="fixe" type="text" size="21" maxlength="99" value=""><br /></td>
				</tr>

				<tr>
					<td class="txt_black" align="left"><b>Adresse : </b></td>
					<td class="txt_black" align="left" colspan="3"><textarea name="adresse"  rows="3" cols="59" ></textarea></td>
				</tr>
				<tr>
					<td class="txt_black" align="left"><b>Login: </b></td>
					<td class="txt_black" align="left"><input name="login" type="text" size="21" maxlength="99" value=""></td>
					<td class="txt_black" align="left" ><b>Mot de passe : </b></td>
					<td class="txt_black" align="left"><input name="pass" type="text" size="21" maxlength="99" value=""><br /></td>
				</tr>
