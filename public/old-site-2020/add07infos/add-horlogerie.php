...
//});
		...
		<div class="div_main">
			<br/>
			<div class="txt_1"><b>Ajouter/Editer horlogerie:</b></div>
			<div id="general_icon" style="background-image:url(img_icons/icon-admin-add.gif);"></div>
			
			<div class="div_form">
				<form name="form12" id="form12" action="process-horlogerie.php" method="post" enctype="multipart/form-data">
                    <? if ($row['id']) { ?>
			...
			<table width="700" cellpadding="2" cellspacing="2" border="0" align="center">
                ...
                <tr>
                  <td class="txt_black" align="left" width="50%"><strong>Grande image (423x337):</strong></td><td> <input name="grande_image" size="9" type="file">
                    <? if ($row['grande_image']) { ?>
