...
//});
		...
		<div class="div_main">
			...
			<table width="700" cellpadding="2" cellspacing="2" border="0" align="center">
				...
				<tr>
					<td class="txt_black" align="left"><b>Promotion : </b></td>
					<td class="txt_black" align="left"><input name="promo" type="text" size="21" maxlength="99" value="<?=$row['promo']?>"></td>
				</tr>
				<tr>
					<td class="txt_black" align="left"><b>Date limite d'utilisation : </b></td>
					<td class="txt_black" align="left"><input name="date" type="text" size="21" maxlength="99" value="<?=$row['promo']?>"></td>
				</tr>
				<tr>
					<td class="txt_black" align="left"><b>Description: </b></td>
					<td class="txt_black" align="left"><textarea name="descriptif"  rows="3" cols="59" ><?=$row['description']?></textarea></td>
				</tr>
				<tr>
                 ...
                 <tr>
                  <td class="txt_black" align="left" width="50%"><strong>Image:</strong></td><td> <input name="image"  size="21" type="file">
                    <? if ($row['image']) { ?>
                    <br /><img src="../photos/150x115_<?=$row['image']?>" />
                    <? }?>
