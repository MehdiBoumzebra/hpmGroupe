...
$q = "SELECT * FROM `nautique` WHERE id = {$_GET["id"]}";
...
?>
		...
		<div class="div_main">
			...
			<div class="div_form">
				<br />
				Est-ce que vous souhaitez effacer définitivement cette annonce ? <u>Ref. <?= $row["id"] ?></u> ?<br />
				<br />
			</div><form name="formulaire" action="process-nautique.php" method="post">
