...
?>
		...
		<div class="div_main">
			<br/>
			<div class="txt_1"><b>Effacer prof:</b></div>
			<!--
			...
			<div class="div_form">
				<br />
				Est-ce que vous souhaitez effacer définitivement cette prof ? <u><?= $row["nom"] ?></u> ?<br />
				<br />
			</div><form name="formulaire" action="process-prof.php" method="post">
