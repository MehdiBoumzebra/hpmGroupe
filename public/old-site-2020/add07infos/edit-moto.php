...
//$q = "SELECT *,modeles.modele as modelelibelle FROM `moto`,modeles WHERE moto.id = {$_GET["id"]} and vehicules.modele=modeles.id";
$q = "SELECT *  FROM `moto` WHERE moto.id = {$_GET["id"]} ";
...
?>
	...
	<tbody><tr>
		<td>
							  <form name="zit_search" id="zit_search" enctype="multipart/form-data" action="process-moto.php" method="post">
