...
$q = "SELECT * FROM boutique  where menu=1 ORDER BY id DESC";
...
<tr>
	<td class="txt_title" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>La liste des boutique :</strong></td>
</tr>
<tr><td colspan="" align="center">
<input type="button" id="ulaitem0z2z3" class="button_1" onmouseover="this.style.backgroundColor='#1E90FF'" onmouseout="this.style.backgroundColor='#1874CD'"   onclick="window.location='index.php?cmd=add-boutique'" value="Ajouter" />
</td>
</tr>
...
<tr>
	<td>
		...
		<tr bgcolor="#FFFFFF" onMouseOver="bgColor='#CAE5FF';" onMouseOut="bgColor='#FFFFFF';">
            ...
            <a href="index.php?cmd=add-boutique&id=<?=$row['id']?>" title="Editer"><img src="img/icon-edit.gif" width="16" height="16" alt="Editer" border="0" /></a>&nbsp;
            <a href="index.php?cmd=delete-boutique&id=<?=$row['id']?>" title="Effacer"><img src="img/icon-delete.gif" width="16" height="16" alt="Effacer" border="0" /></a>&nbsp;
			</td>
		</tr>
		<? }?>
		</table>
