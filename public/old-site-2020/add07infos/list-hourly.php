...
$q = "select * from services, prices where prices.service=services.id and prices.service=2 ";
...
<tr>
	<td>
		...
		<tr bgcolor="#1874CD">
			<td width="10%" class="txt_table_head" align="center"><strong>Max. Heure</strong></td>
			<td width="20%" class="txt_table_head" align="center"><strong>service</strong></td>
		...
		<form name=formres<?=$row[0]?>d id=formres<?=$row[0]?>d action=<?=$_SERVER['PHP_SELF']?>?cmd=list-prices method=post><tr bgcolor="#FFFFFF" onMouseOver="bgColor='#CAE5FF';" onMouseOut="bgColor='#FFFFFF';">
			...
			<td class="txt_table" align="center"><?=$row['name']?></td>
