...
if ($_POST["action"] == "add" || $_POST["action"] == "modify")
		...
		$set = " SET detail".$_POST['lang']." = '".addslashes(($_POST['detail']))."'";
...
//		exit();
	...
	case "delete":
		$q = "DELETE from `sous_menu` WHERE id = {$_POST["id"]} ";
		$r = mysql_query($q);
		if(!$r)
		echo mysql_error();
	}
    	header("Location: index.php?cmd=list-editable&cmd=".$_POST['cmd']."&lang=".$_POST['lang']);
?>
